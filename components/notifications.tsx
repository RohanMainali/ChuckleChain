...
export function Notifications() {
  ...
  const fetchNotifications = async (pageNum = 1, append = false) => {
    try {
      ...
      console.log(`Fetching notifications page ${pageNum} from ${process.env.NEXT_PUBLIC_API_URL}/api/notifications`)
            ...
            {notifications.length === 0 ? (
              ...
              <div className="divide-y">
                {notifications.map((notification, index) => (
                  <div
                    key={notification.id}
                    className={`flex items-start gap-4 p-4 hover:bg-muted/50 cursor-pointer animate-slide-up ${!notification.read ? "bg-muted/30" : ""}`}
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="break-words">{getNotificationText(notification)}</p>
                      </div>
                ...
                {hasMore && (
                  <div className="p-4 flex justify-center">
                    <Button variant="outline" onClick={handleLoadMore} disabled={loadingMore} className="w-full">
                      {loadingMore ? (
                        <>
